        ...
        <div class="modal-content px-5">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center align-items-center py-4 gap-5 flex-wrap text-center">
                    <img src="{{ asset('images/WomenOuterwear.png') }}" alt="Gambar Pakaian Luar Wanita" class="img-fluid me-3" style="max-width: 45%;">
                    <img src="{{ asset('images/SizeWomenOuterwear.png') }}" alt="Tabel Ukuran Pakaian Luar Wanita" class="img-fluid" style="max-width: 45%;">
                </div>
            </div>
        </div>
    </div>
