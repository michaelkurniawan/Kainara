...
<main class="container-fluid py-5 px-5 flex-grow-1">
  <div class="row g-5">
    ...
    <div class="col-lg-6 d-flex align-items-center justify-content-center">
      <img src="{{ asset('images/batik1.jpg') }}" alt="{{ $product['name'] }}" class="img-fluid object-fit-contain" />
    </div>
    ...
    <div class="col-lg-6">
      ...
      <p class="text-muted text-justify mb-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque non erat vitae odio tincidunt varius. Phasellus vel malesuada nunc. Nulla facilisi. Curabitur a lorem tincidunt, egestas enim sed, dictum metus. Sed tincidunt euismod nisi, id tincidunt ipsum vestibulum sed. Integer consectetur, turpis vel viverra cursus, eros elit feugiat odio, at pellentesque ipsum dui at erat. Ut id nunc vel urna aliquet tincidunt. Sed vel nisl turpis. Vivamus tempor lorem sit amet augue malesuada, ac fermentum sapien bibendum.
      ...
      <div class="mb-4" style="max-width: 60%;">
        ...
        <button class="btn rounded-0 btn-lg w-100" style="background-color: #B6B09F; color: white;">Buy it now</button>
      </div>
