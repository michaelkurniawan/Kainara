        ...
        <div class="row align-items-center d-flex justify-content-center">
            <div class="col-lg-5 hero-text-content">
                ...
                <p class="lead fs-4 text-center">
                    Bringing Indonesia's traditional fabrics to the world 
                    through innovation and artistry.
                </p>
            ...
            <div class="col-lg-5 col-md-6 hero-image-container d-flex justify-content-center align-items-center">
